...
public:
    ...
    Plane(float initialpitch, float initialroll,float initialyaw,float initialAltitude, float initialVerticalSpeed, float initialSpeed, const std::string& initialMode);
...
*/
    void land();
/* flare . when plane descends to z= 10m, do the following:
